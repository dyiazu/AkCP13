...
// 🟣 用户配置区域 
// =============================================================================
const UUID = "6a4c570a-830c-4079-ba5a-52120a248eac"; 

// 1. 后台管理密码
const WEB_PASSWORD = "19890912"; //修改你的管理密码
// 2. 快速订阅密码 (访问 https://域名/密码)
const SUB_PASSWORD = "dyiazu"; //修改你的订阅密码

// 3. 默认基础配置
// 🔴 默认 ProxyIP (代码修改此处生效，客户端修改 path 生效)
const DEFAULT_PROXY_IP = "tw.sni2025.netlib.re"; //可自定义修改你的proxyip
